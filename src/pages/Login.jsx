...
import { userLogin } from "../apis/auth"; // QE login
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userObject = {
        ...res.user, // id, userCode, mobile, role, fullName, etc.
        token: res.token,
      };
      ...
      // Redirect after login (update path if you have QE-specific dashboard)
      // e.g. navigate("/qe-dashboard", { replace: true });
